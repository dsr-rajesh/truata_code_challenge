"""
    ...
    Task2: Average Operation on DF columns
"""
import time
import logging
import sys
...
def save_txt(dest_df):
    ...
    dest_df.coalesce(1).write.format("csv").option("header", "true").mode("append").save(
        "C:/Users/DSR/PycharmProjects/truata_code_challenge/tmp/task_3")
    os.rename(
        "C:/Users/DSR/PycharmProjects/truata_code_challenge/tmp/task_3/part-00000-5643c768-e709-4c0c-9fc3-bf99626f3142-c000.csv",
        "C:/Users/DSR/PycharmProjects/truata_code_challenge/out/out_2_3.csv")
...
if __name__ == '__main__':
    ...
    log.info(" TASK_2_3 Program Started")
    try:
        spark = spark_init("Truta: TASK_2_3")
        ...
        log.info(" TASK_2_3 : DF transform completed")
        ...
        log.info("*** TASK_2_3 Completed Successfully in : [{:0>2}hrs:{:0>2}mins:{:05.2f}secs ] ***"
